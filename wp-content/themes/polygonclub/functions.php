...
if (!function_exists('wpbstarter_setup')) :
	...
	function wpbstarter_setup()
	{
		...
		add_image_size('wpbstarter-social', 32, 32, true);
...
function wpbstarter_scripts()
{
	...
	wp_enqueue_style('bootstrap', get_template_directory_uri() . '/assets/css/bootstrap/bootstrap.css', array(), '4.4.1', 'all');
	...
	wp_enqueue_script('bootstrap-bundled-js', get_template_directory_uri() . '/assets/js/bootstrap/bootstrap.bundle.min.js', array('jquery'), '4.4.1', true);
